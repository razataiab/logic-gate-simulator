...
public class notes_lessons extends AppCompatActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ("AND Gate".equals(selectedItem)) {
                    ...
                    Intent intent1 = new Intent(notes_lessons.this, activity_and_gate.class);
                    startActivity(intent1);
                }
                if ("OR Gate".equals(selectedItem)) {
                    // Open the activity_and_gate activity
                    Intent intent2 = new Intent(notes_lessons.this, activity_or_gate.class);
                    startActivity(intent2);
                }
                if ("NOT Gate".equals(selectedItem)) {
                    // Open the activity_and_gate activity
                    Intent intent3 = new Intent(notes_lessons.this, activity_or_gate.class);
                    startActivity(intent3);
                }
                if ("NAND Gate".equals(selectedItem)) {
                    // Open the activity_and_gate activity
                    Intent intent4 = new Intent(notes_lessons.this, activity_nand_gate.class);
                    startActivity(intent4);
                }
                if ("NOR Gate".equals(selectedItem)) {
                    // Open the activity_and_gate activity
                    Intent intent5 = new Intent(notes_lessons.this, activity_nor_gate.class);
                    startActivity(intent5);
                }
                if ("XOR Gate".equals(selectedItem)) {
                    // Open the activity_and_gate activity
                    Intent intent6 = new Intent(notes_lessons.this, activity_xor_gate.class);
